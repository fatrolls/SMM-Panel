...
if (isset($_GET['id'])) {
	...
	if ($data_target['count'] == 0) {
		$_SESSION['result'] = array('alert' => 'danger', 'title' => 'Fail', 'msg' => 'Tickets Not Found');
...
?>
				...
				<div class="row">
					<div class="offset-md-2 col-md-8">
						<a href="<?php echo $config['web']['base_url'] ?>ticket" class="btn btn-primary" style="margin-bottom: 20px;"><i class="fa fa-arrow-left fa-fw"></i> Return</a>
						<div class="card-box">
							<h4 class="header-title m-t-0 m-b-30"><i class="fa fa-edit"></i> Reply Tickets: <?php echo $data_target['rows']['subject']; ?></h4>

...
?>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30"><i class="fa fa-envelope"></i> Ticket List</h4>
                            	<td align="center"><a href="<?php echo $config['web']['base_url']; ?>ticket/submit.php" class="btn btn-sm btn-info" ><i class="fa fa-submit"></i>Open Tickets</a></td>
                                        ...
                                        <div class="table-responsive">
											...
											<tbody>
												<tr>
													...
													<td align="center"><a href="<?php echo $config['web']['base_url']; ?>ticket/reply.php?id=<?php echo $data_query['id']; ?>" class="btn btn-sm btn-info" ><i class="fa fa-reply"></i> Reply</a></td>
												</tr>
                                            </tbody>
											<?php
											}

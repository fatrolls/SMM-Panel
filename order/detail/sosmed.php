                                ...
                                <div class="ibox-content">
                	                    <div class="table-responsive">
                                            <table class="table table-stripped" data-page-size="8" data-filter=#filter>
												...
												<tr>
													<td><b>PRICE</b></td>
													<td>$ <?php echo number_format($data_query['rows']['price'],0,',','.') ?></td>
												</tr>
												<tr>
													<td><b>STATUS</b></td>
												...
												<tr>
													<td><b>REFUND</b></td>
													<td><?php echo ($data_query['rows']['is_refund'] == 1) ? 'YA ('.$total_refund.')' : 'NO' ?></td>
												</tr>
						                    </table>
					                    </div>
                                    </div>

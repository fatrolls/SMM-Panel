...
?>
						<div class="row">
							<div class="col-lg-12">
								<a href="javascript:;" onclick="modal_open('add', '<?php echo $config['web']['base_url'] ?>admin/service/lib/add.php');" class="btn btn-success" style="margin-bottom: 15px"><i class="fa fa-plus-square"></i> Plus</a>
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-list"></i> Service Data</h4>
										...
										<table class="table table-striped table-bordered table-hover" id="datatable">
											...
											?>
												<tr>
													...
													<td>$ <?php echo number_format($data_query['price'],0,',','.') ?></td>
													<td>$ <?php echo number_format($data_query['profit'],0,',','.') ?></td>

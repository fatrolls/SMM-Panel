...
?>
						<div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-list"></i> Order Data</h4>
										<div class="alert alert-info">The only orders that can be changed are those with the status <i>Pending</i> and <i>Processing</i>, the only data that can be changed is the Initial Quantity and Short Quantity.</div>

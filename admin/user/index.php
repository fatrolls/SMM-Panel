...
?>
						<div class="row">
							<div class="col-lg-12">
								<a href="javascript:;" onclick="modal_open('add', '<?php echo $config['web']['base_url'] ?>admin/user/lib/add.php');" class="btn btn-success" style="margin-bottom: 15px"><i class="fa fa-plus-square"></i> Plus</a>
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-list"></i> Data Users</h4>
										...
										<table class="table table-striped table-bordered table-hover" id="datatable">
											...
											?>
												<tr>
													...
													<td>$ <?php echo number_format($data_query['balance'],0,',','.') ?></td>
													<td>$ <?php echo number_format($model->db_query($db, "SUM(price) as total", "orders WHERE user_id = '".$data_query['id']."'")['rows']['total'],0,',','.') ?></td>

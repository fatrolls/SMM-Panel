...
?>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-info-circle"></i> Displaying Information: <?php echo (isset($_GET['start_date']) AND isset($_GET['end_date'])) ? 'Date '.format_date($_GET['start_date']).' until '.format_date($_GET['end_date']) : 'All Deposits' ?></h4>
										...
										<table class="table table-striped table-bordered table-hover">
											...
											<tr>
												...
												<td>$ <?php echo number_format($pending['rows']['total'],0,',','.') ?> (<?php echo $pending['total'] ?>)</td>
												<td>$ <?php echo number_format($success['rows']['total'],0,',','.') ?> (<?php echo $success['total'] ?>)</td>
												<td>$ <?php echo number_format($canceled['rows']['total'],0,',','.') ?> (<?php echo $canceled['total'] ?>)</td>
											</tr>
										</table>
										</div>
